 ...
 */
abstract class restore_search_base_import implements renderable
{
    /**
     ...
     * @return array
     */
    final public function get_shortnameresults($coursecode,$shortnamestr) {
    ...
    final public function search() {
        ...
        //$str = $COURSE->shortname;
        //$coursecode = substr($str, 0, strpos($str, '-'));
...
class restore_course_search_import extends restore_search_base_import
{
    static $VAR_SEARCH = 'search';
    protected $currentcourseid = null;
    protected $includecurrentcourse = false;
    /**
     * @param array $config
...
class new_import_course_search extends restore_course_search_import
{
    /**
     * Sets up any access restrictions for the courses to be displayed in the search.
     *
