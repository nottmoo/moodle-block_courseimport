...
$string['courseimport:bulkrollover'] = 'Use bulk rollover in the course import block';
...
$string['bulkactiveimports'] = 'You have an active bulk import in progress';
...
$string['bulkpreviewheading'] = 'Bulk import preview';
$string['bulkpreviewsummary'] = 'Rows: {$a->rows}, resolved: {$a->resolved}, unmatched: {$a->unmatched}';
$string['bulkpreviewresolved'] = 'Resolved pairs';
$string['bulkpreviewerrors'] = 'Unmatched rows';
$string['bulkpreviewnoerrors'] = 'No unmatched rows found.';
$string['bulkconfirmsubmit'] = 'Confirm and create jobs';
$string['bulkbacktoupload'] = 'Back to upload';
$string['bulkduplicatetargets'] = 'Duplicate target course IDs are not allowed in one submission.';
$string['bulkpreviewinvalidtoken'] = 'Preview session expired. Please upload the CSV again.';
$string['bulksubmitcreated'] = 'Bulk job #{$a->bulkid} created. Jobs queued: {$a->created}, failed before queue: {$a->failed}.';
$string['bulkenabledsettingstitle'] = 'Enabled import settings';
$string['bulkenabledsettingsintro'] = 'These settings are applied to the bulk rollover profile.';
$string['bulkenabledsettingsnone'] = 'No optional include settings are enabled. Adjust import settings to include more content.';
$string['bulkgotoimportsettings'] = 'Go to import settings';
$string['bulkmaxrowsexceeded'] = 'This CSV has more than the allowed {$a} rows. Please split the file into smaller parts.';
$string['bulkstatuslistheading'] = 'Your recent bulk imports';
$string['bulkstatusid'] = 'Bulk job #{$a}';
$string['bulkstatuscolumnd'] = 'Bulk job';
$string['bulkstatustotal'] = 'Total pairs';
...
$string['bulkstatusrefreshing'] = 'Import in progress — this page will refresh automatically every 5 seconds.';
$string['bulkstatuschildjobs'] = 'Import jobs in this bulk run';
$string['bulkstatusjobid'] = 'Job';
...
$string['bulkstatusnone'] = 'No bulk jobs found.';
$string['bulknochildjobs'] = 'No individual import jobs are linked to this bulk run.';
$string['bulkstatusinvalid'] = 'Bulk job not found or access denied.';
$string['bulkresultsheading'] = 'Bulk import results';
$string['bulkpagination'] = 'Showing {$a->from}–{$a->to} of {$a->total}';
$string['bulkshowallchildjobs'] = 'Show all import jobs';
$string['bulkshowcompletedchildjobs'] = 'Show completed imports only';
...
$string['pluginname'] = 'Course import Settings';
...
$string['privacy:metadata:block_courseimport:bulk_job_id'] = 'The optional parent bulk job id this import belongs to.';
