...
$string['privacy:metadata:block_courseimport:courseid'] = 'The course that data is being exported from.';
$string['privacy:metadata:block_courseimport:status'] = 'The status of the import.';
$string['privacy:metadata:block_courseimport:targetcourseid'] = 'The course that is being imported into.';
