...
$string['bulkstatusrefreshing'] = 'Import in progress — progress updates automatically without reloading the page.';
...
$string['bulkchildjobfiltersnav'] = 'Filter which import jobs are listed';
